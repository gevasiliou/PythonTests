...
function getPowerOutages(e) {
    $.ajax({
        ...
        success: function(e, t, a) {
            0 != e.length ? (document.getElementById("no_outage_found").style.display = "inline",
            document.getElementById("outages_list").style.display = "inline",
            $("#dataTable_outages").DataTable().rows.add(e).draw()) : (document.getElementById("outages_list").style.display = "inline",
            document.getElementById("no_outage_found").style.display = "inline",
            $("#dataTable_outages").DataTable().clear().draw())
        },
        error: function(e, t, a) {
            document.getElementById("no_outage_found").style.display = "inline",
...
function sendPIN(e) {
    ...
    $.ajax({
        ...
        beforeSend: function() {
            ...
            loadingInProgress = !0,
            document.getElementById("user_info_pin_response").style.display = "inline"
        },
        success: function(e, t, a) {
...
function validateFailure() {
    ...
    $.ajax({
        ...
        beforeSend: function() {
            ...
            document.getElementById("supply_no_recall").style.display = "inline"
        },
        success: function(e, t, a) {
