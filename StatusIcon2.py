...
#        self.button=1
#        self.time=None
#        self.connect("popup_menu", self.button, self.time, self.on_primary_click)
    ...
    #def on_secondary_click(self):
        ...
        menu.popup(None,None,None, 3, time) #modified line - working ok now. The integer 3 if it becomes 1 or 2 makes no difference
