#http://pygtk.org/pygtk2tutorial/examples/menu.py
#!/usr/bin/env python

# example menu.py for creating a gtk window (not related to tray icon)
# Other gtk window example: http://www.pygtk.org/pygtk2tutorial/sec-CheckButtons.html#checkbuttonfig
# For more examples see last section of the pygtk tutorial : http://www.pygtk.org/pygtk2tutorial/
